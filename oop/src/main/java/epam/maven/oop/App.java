...
public class App 
{
    public static void main( String[] args )
    {
     ...
     // List of objects of the sweet class 
        ...
        Sweets chco1=new Chocolates("kitkat","100%", 2,10);
        gift.add(chco1);
        Sweets chco2=new Chocolates("milkytreat","100%", 1,20);
        gift.add(chco2);
        Sweets chco3=new Candy("Snickers","50%", 2,10);
        gift.add(chco3);
        Sweets chco4=new Candy("mahalacto","20%", 8,10);
        gift.add(chco4);
